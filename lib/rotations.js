...
- End with a question they can answer from their own experience ("Have you checked your website on a phone lately?" etc.)`,
    ...
    imagePrompt: `Clean, warm editorial photograph. A South African business owner — restaurant, retail, or service setting — holding a phone or sitting at a laptop with a focused expression. Natural lighting, real environment. Phone or laptop screen not visible or blurred. No stock-photo feel. Warm tones, authentic. Square 1:1 format.`,
  },
...
- End with a relatable question ("How much time do you spend on WhatsApp every day?" etc.)`,
    ...
    imagePrompt: `Clean dark minimal graphic on black background. Abstract representation of instant communication — a bold notification icon, a fast reply symbol, or a stylised clock showing after-hours time with a green checkmark. Dark background (#080808), white and green accent elements. No readable text. No chat bubbles with words. Professional, minimal. Square 1:1 format.`,
  },
...
- End with a relatable question about their own social media habits.`,
    ...
    imagePrompt: `Clean dark minimal graphic. Abstract content calendar visual — a grid of squares representing scheduled posts, some filled, some empty, with a clock or calendar icon. Dark background, clean white elements, one teal accent. No readable text on screen. No social media UI. Modern, confident. Square 1:1 format.`,
  },
...
- End with a question they can relate to locally.`,
    ...
    imagePrompt: `Warm editorial photograph with South African context. A business setting — a restaurant, a market stall, a retail space — with a business owner at work. Authentic, local feel. Natural light. Real environment. No phone or computer screens showing readable UI or text. Square 1:1 format.`,
  },
...
- Include ONE link: rebeldesigns.co.za`,
    ...
    imagePrompt: `Modern, clean dark graphic. Abstract automation visual — interconnected nodes, a circular flow diagram, or a bold phone icon with lightning bolt symbols. Minimal, professional, dark background (#080808). Teal accent elements. No readable text. No chat bubbles. No social media feed UI. Real and functional looking. Square 1:1 format.`,
  },
