...
const SNAPSHOT = {
  ...
  brandFacts: {
    positioning: "Infrastructure architecture practice for startups and growth-stage companies",
    tagline: "Most websites are built for launch day. We build for year five.",
    capabilities: ["System Architecture", "AI & Automation", "Commerce Infrastructure"],
    ...
    contact: {
      email: "info@rebeldesigns.co.za",
      whatsapp: "+27 60 578 0813",
    },
  },
};