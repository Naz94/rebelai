...
// ── Facebook — post to Page feed with image link ─────────────
// Posts directly to /{page-id}/feed with the Blob image URL as
// the `link` field and copy as `message`.
// Avoids /photos endpoint (triggers publish_actions deprecation)
// and avoids unpublished photo staging (blocked on new Pages experience).
