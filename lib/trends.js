...
CRITICAL RULE — no third-person character framing. Never write "A restaurant owner does X" or "A retailer struggles with Y." The reader must recognise themselves in the statement — not read about someone else. Use second person ("You haven't posted in three weeks") or direct declarative ("The page looks abandoned. New customers notice.").

BAD — third-person character (reject this pattern completely):
HOOK A: A tradesperson spends half their day writing quotes and chasing invoices instead of working on jobs.
ANGLE 1: A retailer spends hours each week manually processing online orders.

GOOD — direct declarative or second person:
HOOK A: Half the day gone to quotes and invoices. No jobs started yet.
ANGLE 1: Most businesses taking orders on WhatsApp hit a wall. The order comes in, someone has to process it, confirm it, follow up. It doesn't stop.
...
"top-of-mind", "what really matters", "free up their time", "missed opportunities", "keep their brand", "feel impossible", "looking for effective ways", "many businesses", "business owners juggle", "can feel", "might be", "could be", "enjoy a steady", "without daily effort", "connection and sales", "proper tools", "invest in", "missing out on", "leads to a damaged"

Do NOT start any line with: "A restaurant owner", "A retailer", "A tradesperson", "A business owner", "A service business", "A small business owner" — third-person character framing is banned entirely.`,
      },
    ],
  });
