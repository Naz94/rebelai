...
export async function generateCopy(rotation, platform, resourceSnapshot, postHistory = [], intelligenceBrief = null, overrides = {}) {
  ...
  // Value posts are REQUIRED to end with a question by their rotation brief.
  // Lab/showcase posts must end with a CTA.
  ...
  do {
    ...
    const response = await client.chat.completions.create({
      model:      "gpt-4o",
      max_tokens: 350,           // Facebook <=200w, Instagram <=100w — 350 tokens is sufficient
      messages: [
