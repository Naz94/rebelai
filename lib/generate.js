...
- NEVER use an em-dash (—). Use a full stop or a new sentence instead.
- AUTOMATIC REJECTION — these phrases will cause a retry. Do not use them:
  "changes the game", "is crucial", "are crucial", "game-changer",
  "seamless", "seamlessly", "you're not alone", "make all the difference",
  "lifting a finger", "all night long", "imagine handling", "imagine automating",
  "sounds like a dream", "it's like having a", "without breaking a sweat",
  "enables you to", "empowers you to", "leverage", "cutting-edge",
  "revolutionise", "revolutionize", "world-class", "best-in-class"
- Do NOT open with: "Are you tired of", "Did you know", "Imagine", "In today's",
  "It's no secret", "Unlock", "Transform your", "Picture this", "Here's why"
- Do NOT use rhetorical questions mid-post ("But what if...?", "right?", "isn't it?")
- Plain language only. No jargon. No clichés. No marketing speak.
- Every sentence must add new information — no restating the previous sentence
- Do NOT invent URLs — only use the exact URLs from the verified content above
- Do NOT name projects unless this is a showcase post
${closingRule}
