...
// ─────────────────────────────────────────────────────────────
// INSTAGRAM ADAPTER
// Takes approved Facebook copy and produces an identical Instagram
// version: same opening line, same message, same CTA/question —
// compressed to ≤100 words with exactly 25 hashtags appended.
//
// Uses gpt-4o-mini (cheaper). No quality gate needed — the source
// copy is already approved Facebook output.
//
// Called by content.js handleGenerate and lib/caption.js instead
// of running a second independent generateCopy for Instagram.
// ─────────────────────────────────────────────────────────────
...
- The post must feel like it was written today about something real`.trim();
  ...
  //
  // NOTE: platform is always "facebook" here — Instagram copy is
  // produced by adaptForInstagram() from the approved Facebook output.
  // The instagramTemplate is retained for the caption flow (platforms="instagram" only).
