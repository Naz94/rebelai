...
- Do NOT end the post with a question — close with a declarative statement or an architectural observation
...
const BANNED_PHRASES = [
  ...
  "consider the difference",          // passive filler
  "not by chance, but by",            // tagline cliché
  "without it, ai",                   // vague negative framing
  "mere automation",                  // cliché contrast
  "true intelligence",                // marketing speak
];

// Detects posts that end with a question (closing question ban).
...
function passesQualityGate(copy, platform = "facebook") {
  ...
  // ── Closing question ban ─────────────────────────────────
  if (endsWithQuestion(copy)) {
    console.warn("[generate] Post ends with a question — retrying");
    return false;
  }
