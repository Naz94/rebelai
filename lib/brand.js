...
BRAND FACTS:
- Verticals: High-end Shopify (Hydrogen/headless), WordPress (custom-engineered, not themes), Custom Web Applications, AI Automation Systems
- AI Systems: Rebel Designs designs and builds AI-driven operational infrastructure — autonomous content agents, automation pipelines, and AI-integrated business systems. Posts about AI systems should explain the architecture. Let the intelligence of the system signal the capability.
...
export const PLATFORM_INSTRUCTIONS = {
  facebook:  "Facebook post. Max 220 words. Technically precise, authoritative, direct. Short sentences. Explain the architectural WHY, not just the what. Pure Value posts: end with a genuine technical question inviting debate. Lab posts: one URL maximum — always rebeldesigns.co.za (tools are on the homepage). 3-5 targeted hashtags at the very end.",
  instagram: "Instagram caption. Max 110 words. Dense and punchy — a developer should learn something in 20 seconds. Max 2 emojis. Pure Value posts: end with a question. Lab posts: one URL — always rebeldesigns.co.za (tools are on the homepage). Then on a new line output only hashtags (no label like [HASHTAGS], no word hashtags), with 25 niche hashtags covering the specific technology, web development craft, and South African dev community.",
};
