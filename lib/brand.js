// ============================================================
// REBEL DESIGNS — Brand System Prompt
...
- For LinkedIn: Start with a single bold hook line. Use line breaks for rhythm. 5 hashtags at the end.
- For Facebook: Conversational but authoritative. 3-5 hashtags inline at the end.
...
export const PLATFORM_INSTRUCTIONS = {
  linkedin: "LinkedIn post. Max 220 words. Professional and insightful. Starts with a single bold hook line that works standalone. 5 relevant professional hashtags at the end after a line break.",
  facebook: "Facebook post. Max 300 words. Authoritative but slightly more accessible. 3-5 targeted hashtags at the very end.",
  instagram: "Instagram caption. Max 150 words. Punchy and visual — the image does heavy lifting. Max 3 strategic emojis. Then on a new line write [HASHTAGS] followed by 25 niche hashtags relevant to web development, South Africa, and the topic.",
};
