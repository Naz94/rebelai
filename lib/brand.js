...
export const PLATFORM_INSTRUCTIONS = {
  ...
  instagram: "Instagram caption. Max 120 words. Dense and punchy — a developer should learn something in 20 seconds. Max 2 emojis. Pure Value posts: end with a question. Lab posts: one URL. Then on a new line output only hashtags (no label like [HASHTAGS], no word hashtags), with 25 niche hashtags covering the specific technology, web development craft, and South African dev community.",
};
